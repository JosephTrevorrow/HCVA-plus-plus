...
#SBATCH --job-name=ia23938-random_8
#SBATCH --output=random_8.out
#SBATCH --error=random_8.err
...
python -O runner.py -min 280 -max 319 -pvs_dir "value_systems/Synthetic/randoms/PVS/" -prip_dir "value_systems/Synthetic/randoms/PriP/" -n_values 4 -n_actions 2 -output_dir "results/randoms/"
