...
#SBATCH --job-name=ia23938-grp_fact_6
#SBATCH --output=grp_fact_6.out
#SBATCH --error=grp_fact_6.err
...
python -O runner.py -min 200 -max 239 -pvs_dir "value_systems/Synthetic/vary_grp_fact/PVS/" -prip_dir "value_systems/Synthetic/vary_grp_fact/PriP/" -n_values 4 -n_actions 2 -output_dir "results/SYNTH_vary_grp_fact/"
