...
#SBATCH --job-name=ia23938-grp_fact_10
#SBATCH --output=grp_fact_10.out
#SBATCH --error=grp_fact_10.err
...
python -O runner.py -min 360 -max 400 -pvs_dir "value_systems/Synthetic/vary_grp_fact/PVS/" -prip_dir "value_systems/Synthetic/vary_grp_fact/PriP/" -n_values 4 -n_actions 2 -output_dir "results/SYNTH_vary_grp_fact/"
