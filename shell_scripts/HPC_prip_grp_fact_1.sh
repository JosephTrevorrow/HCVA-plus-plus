...
#SBATCH --job-name=ia23938-prip_grp_1
#SBATCH --output=prip_grp_1.out
#SBATCH --error=prip_grp_1.err
...
python -O runner.py -min 0 -max 39 -pvs_dir "value_systems/Synthetic/vary_prip_grp_fact/PVS/" -prip_dir "value_systems/Synthetic/vary_prip_grp_fact/PriP/" -n_values 4 -n_actions 2 -output_dir "results/vary_prip_grp_fact/"
