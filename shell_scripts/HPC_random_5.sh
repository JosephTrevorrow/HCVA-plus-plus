...
#SBATCH --job-name=ia23938-random_5
#SBATCH --output=random_5.out
#SBATCH --error=random_5.err
...
python -O runner.py -min 160 -max 199 -pvs_dir "value_systems/Synthetic/randoms/PVS/" -prip_dir "value_systems/Synthetic/randoms/PriP/" -n_values 4 -n_actions 2 -output_dir "results/randoms/"
