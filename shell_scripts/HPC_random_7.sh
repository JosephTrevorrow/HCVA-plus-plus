...
#SBATCH --job-name=ia23938-random_7
#SBATCH --output=random_7.out
#SBATCH --error=random_7.err
...
python -O runner.py -min 240 -max 279 -pvs_dir "value_systems/Synthetic/randoms/PVS/" -prip_dir "value_systems/Synthetic/randoms/PriP/" -n_values 4 -n_actions 2 -output_dir "results/randoms/"
