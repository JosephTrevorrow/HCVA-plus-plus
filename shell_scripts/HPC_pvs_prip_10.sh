...
#SBATCH --job-name=ia23938-pvs_prip_10
#SBATCH --output=pvs_prip_10.out
#SBATCH --error=pvs_prip_10.err
...
python -O runner.py -min 360 -max 400 -pvs_dir "value_systems/Synthetic/vary_pvs_prip/PVS/" -prip_dir "value_systems/Synthetic/vary_pvs_prip/PriP/" -n_values 4 -n_actions 2 -output_dir "results/SYNTH_vary_pvs_prip/"
