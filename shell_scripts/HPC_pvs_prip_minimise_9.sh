...
#SBATCH --job-name=ia23938-minimise_9
...
python -O runner.py -min 320 -max 359 -pvs_dir "value_systems/Synthetic/vary_sigma_prip_MINIMISE/PVS/" -prip_dir "value_systems/Synthetic/vary_sigma_prip_MINIMISE/PriP/" -n_values 4 -n_actions 2 -output_dir "results/vary_sigma_prip_MINIMISE/"
