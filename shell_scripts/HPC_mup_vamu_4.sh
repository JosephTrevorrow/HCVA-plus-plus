...
#SBATCH --job-name=ia23938-mup_vamu_4
#SBATCH --output=mup_vamu_4.out
#SBATCH --error=mup_vamu_4.err
...
python -O runner.py -min 120 -max 159 -pvs_dir "value_systems/Synthetic/vary_mup_vamu/PVS/" -prip_dir "value_systems/Synthetic/vary_mup_vamu/PriP/" -n_values 4 -n_actions 2 -output_dir "results/SYNTH_vary_mup_vamu/"
