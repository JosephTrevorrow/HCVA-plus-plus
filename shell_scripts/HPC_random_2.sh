...
#SBATCH --job-name=ia23938-random_2
#SBATCH --output=random_2.out
#SBATCH --error=random_2.err
...
python -O runner.py -min 40 -max 79 -pvs_dir "value_systems/Synthetic/randoms/PVS/" -prip_dir "value_systems/Synthetic/randoms/PriP/" -n_values 4 -n_actions 2 -output_dir "results/randoms/"
