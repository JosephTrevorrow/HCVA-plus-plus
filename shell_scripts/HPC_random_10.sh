...
#SBATCH --job-name=ia23938-random_10
#SBATCH --output=random_10.out
#SBATCH --error=random_10.err
...
python -O runner.py -min 360 -max 400 -pvs_dir "value_systems/Synthetic/randoms/PVS/" -prip_dir "value_systems/Synthetic/randoms/PriP/" -n_values 4 -n_actions 2 -output_dir "results/randoms/"
