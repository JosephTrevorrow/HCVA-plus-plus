...
#SBATCH --job-name=ia23938-random_1
#SBATCH --output=random_1.out
#SBATCH --error=random_1.err
...
python -O runner.py -min 0 -max 39 -pvs_dir "value_systems/Synthetic/randoms/PVS/" -prip_dir "value_systems/Synthetic/randoms/PriP/" -n_values 4 -n_actions 2 -output_dir "results/randoms/"
