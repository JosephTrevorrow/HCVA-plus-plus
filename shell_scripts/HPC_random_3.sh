...
#SBATCH --job-name=ia23938-random_3
#SBATCH --output=random_3.out
#SBATCH --error=random_3.err
...
python -O runner.py -min 80 -max 119 -pvs_dir "value_systems/Synthetic/randoms/PVS/" -prip_dir "value_systems/Synthetic/randoms/PriP/" -n_values 4 -n_actions 2 -output_dir "results/randoms/"
