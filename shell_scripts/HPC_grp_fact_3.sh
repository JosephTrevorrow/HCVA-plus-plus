...
#SBATCH --job-name=ia23938-grp_fact_3
#SBATCH --output=grp_fact_3.out
#SBATCH --error=grp_fact_3.err
...
python -O runner.py -min 80 -max 119 -pvs_dir "value_systems/Synthetic/vary_grp_fact/PVS/" -prip_dir "value_systems/Synthetic/vary_grp_fact/PriP/" -n_values 4 -n_actions 2 -output_dir "results/SYNTH_vary_grp_fact/"
