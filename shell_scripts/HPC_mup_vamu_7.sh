...
#SBATCH --job-name=ia23938-mup_vamu_7
#SBATCH --output=mup_vamu_7.out
#SBATCH --error=mup_vamu_7.err
...
python -O runner.py -min 240 -max 279 -pvs_dir "value_systems/Synthetic/vary_mup_vamu/PVS/" -prip_dir "value_systems/Synthetic/vary_mup_vamu/PriP/" -n_values 4 -n_actions 2 -output_dir "results/SYNTH_vary_mup_vamu/"
