...
#SBATCH --job-name=ia23938-random_4
#SBATCH --output=random_4.out
#SBATCH --error=random_4.err
...
python -O runner.py -min 120 -max 159 -pvs_dir "value_systems/Synthetic/randoms/PVS/" -prip_dir "value_systems/Synthetic/randoms/PriP/" -n_values 4 -n_actions 2 -output_dir "results/randoms/"
