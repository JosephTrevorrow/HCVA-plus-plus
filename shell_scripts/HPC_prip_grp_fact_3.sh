...
python -O runner.py -min 80 -max 119 -pvs_dir "value_systems/Synthetic/vary_prip_grp_fact/PVS/" -prip_dir "value_systems/Synthetic/vary_prip_grp_fact/PriP/" -n_values 4 -n_actions 2 -output_dir "results/vary_prip_grp_fact/"
