...
#SBATCH --job-name=ia23938-random_6
#SBATCH --output=random_6.out
#SBATCH --error=random_6.err
...
python -O runner.py -min 200 -max 239 -pvs_dir "value_systems/Synthetic/randoms/PVS/" -prip_dir "value_systems/Synthetic/randoms/PriP/" -n_values 4 -n_actions 2 -output_dir "results/randoms/"
